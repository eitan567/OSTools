...
import TextFieldWithRegenerate from '../../components/common/TextFieldWithRegenerate';
import StarBorderIcon from '@mui/icons-material/StarBorder';
import StarIcon from '@mui/icons-material/Star';
import StarHalfIcon from '@mui/icons-material/StarHalf';
import './ImageTable.css';
import SimpleModal from '../../components/common/Dialog';
...
const getCategoryName = (categoryNumber) => {
  return categoryNumber && categories[categoryNumber] ? `${categoryNumber} - ${categories[categoryNumber]}` : "Unknown";
};
...
const CheckStatusIcon = React.memo(({ checkStatus, checkReason }) => {
  switch (checkStatus) {
    case 'good':
...
const ImageTable = ({ images, onRegenerateField, onSelectImage, onSelectAll, onProcessImage, processingImages, onUpdateImage }) => {
  ...
  const ThumbnailTooltip = React.memo(({ image }) => (
    <div>
